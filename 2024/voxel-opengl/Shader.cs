...
namespace Voxelator
{
    public class Shader : IDisposable
    {
        ...
        public Shader(GL gl, string vertexPath, string fragmentPath)
        {
            ...
            uint vertex = LoadShader(_gl, ShaderType.VertexShader, vertexPath);
            uint fragment = LoadShader(_gl, ShaderType.FragmentShader, fragmentPath);
        ...
        public static uint LoadShader(GL _gl, ShaderType type, string path)
        {
